...
$result = mysql_query("SELECT * FROM product_sale WHERE product='g'");
		...
		<script>
            ...
            <div id="sidebar">
                ...
                <div class="list">
                    ...
                    <div class="col-1-2">
                        <ul class="demo1">
                            <li><a href="total-salemeng.php">Mengniu</a></li>
                            <li><a href="total-saleyi.php">Yili</a></li>
                            <li><a href="#" style=" font-weight: bold ; color: #0044cc ">Guangming</a></li>
