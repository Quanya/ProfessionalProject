...
$result = mysql_query("SELECT * FROM taodata5 WHERE productid=28");
$i=1;
...
<div class="tabContainer">
	<ul id="tabCot_product-li-currentBtn-">
            <li class="currentBtn"><a href="sales_mapmeng.php" title="蒙牛" rel="1">蒙牛</a></li>
		<li><a href="sales_mapyi.php" title="伊利" rel="2">伊利</a></li>
		<li><a href="#" title="光明" rel="3"style="font-weight:  bolder;color: #F07402">光明</a></li>
	</ul>
</div>

<div id="tabCot_product_3">
