				  ...
				  <div class="main clearfix">
				    ...
				    <div class="column">
					  ...
					  <!--前三名-->
	                    ...
	                    <a href="" class="red">Third</a>
					  <!--4~7 设置一种颜色-->	
	                    <a href="" class="blue">Fourth</a>
	                    <a href="" class="blue">Fifth</a>
	                    <a href="" class="blue">Sixth</a>
	                    <a href="" class="blue">Seventh</a>
					  <!--8~10-->
					    <a href="" class="yellow">bottom</a>
	                    <a href="" class="yellow">bottom</a>
	                    <a href="" class="yellow">bottom</a>
